                ...
                <div class="card-body">
                    ...
                    <div class="row m-b-30">
                        <div class="col-12 d-flex justify-content-end p-h-30">
                            <div class="row">
                                <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/admin/siswa/add') ?>">Tambah Siswa</a>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-10">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($dataAdmin as $data) : ?>
                                        <tr>
                                            ...
                                            <td><?= $data['email'] ?></td>
                                            <td>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/siswa/' . $data['id_siswa'] . '/view') ?>">
                                                    <i class="anticon anticon-eye" style="color: #336CFB;"></i>
                                                </a>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/siswa/' . $data['id_siswa'] . '/edit') ?>">
                                                    <i class="anticon anticon-form" style="color: #049F67;"></i>
                                                </a>
                                                <button class="btn btn-icon btn-hover btn-sm btn-rounded btn-hapus-keg" style="cursor: pointer;" data-id="<?= $data['id_siswa'] ?>" data-judul="<?= $data['nama_siswa'] ?>">
