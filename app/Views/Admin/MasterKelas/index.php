            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>Data Seluruh Kelas Siswa</h5>
                    </div>
                    <hr>
                    ...
                    <div class="row m-b-30">
                        <div class="col-12 d-flex justify-content-end p-h-30">
                            <div class="row">
                                <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/admin/kelas/add') ?>">Tambah Siswa ke Kelas</a>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-10">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($dataAdmin as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/kelas/' . $data['id_kelas'] . '/edit') ?>">
                                                    <i class="anticon anticon-form" style="color: #049F67;"></i>
                                                </a>
                                                <button class="btn btn-icon btn-hover btn-sm btn-rounded btn-hapus-keg" style="cursor: pointer;" data-id="<?= $data['id_kelas'] ?>" data-judul="<?= $data['nama_siswa'] ?>">
