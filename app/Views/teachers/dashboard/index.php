            ...
            <div class="card">
                <div class="card-body">
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container">
                            <h1 class="display-4">Pengaruh guru meluas di luar kelas, jauh ke masa depan</h1>
                            <p class="lead">- F. Sionil Jose</p>
                        </div>
                    </div>

                    <section class="lp-mobile-view">
                        <div class="container">
                            <h4>Pengaruh guru meluas di luar kelas, jauh ke masa depan</h4>
                            <p>- F. Sionil Jose</p>
                        </div>
                    </section>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>My Class</h5>
                        <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/teacher/add/matkul') ?>">Add Class</a>
                    </div>
                    <hr>
                                ...
                                <div class="content-info-jurnal">
                                    <div class="row">
                                        <?php foreach ($class as $display) : ?>
                                            <div class="col-lg-3 col-md-6" onclick="location.href='<?= base_url('/teacher/matakuliah/' . $display['slug']) ?>'" style="cursor: pointer;">
